...
void Company::LoadItems()
{
	...
	if (!inFile)
	{
		cerr << "Não foi possível abrir o ficheiro itens.txt";
		exit(1);
	}
...
void Company::LoadTrucks()
{
	...
	if (!inFile)
	{
		cerr << "Não foi possível abrir o ficheiro camioes.txt";
		exit(1);
	}
...
void Company::ReadMapInfo()
{
	...
	if (!inFile) {
		cerr << "Nao foi possível abrir o ficheiro mapa_info.txt";
		exit(1);
	}
	...
	if (!inFile) {
		cerr << "Nao foi possível abrir o ficheiro nodes.txt";
		exit(1);
	}
	...
	if (!inFile) {
		cerr << "Nao foi possível abrir o ficheiro ruas.txt";
		exit(1);
	}
	...
	if (!inFile) {
		cerr << "Nao foi possível abrir o ficheiro streets.txt";
		exit(1);
	}
